...
const CALC_PROGRAMS_DATA = {
  specialists: [
    ...
    { id: 'p-46v', code: '46В', name: 'Программа «В» — Работы повышенной опасности (16 ч.)', price: 1200, checked: false },
  ...
  workers: [
    ...
    { id: 'pw-46v', code: '46В', name: 'Программа «В» — повышенная опасность для рабочих (16 ч.)', price: 500, checked: false },
